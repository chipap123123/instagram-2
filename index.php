...
<html lang="en">
  ...
  <body>
				...
				<div class="mt-5 border rounded">   
					<div class="col-12 px-1">
						<div class="row">
							...
							<div class="col-1" style="margin-left: 525px;">
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div class="col-2">
								<button class="btn btn-success mt-1 knopka"><i class="fa fa-edit"></i></button>
	 							<form action="update.php" method="GET" class="ok forma" style="display: none;" >
	 								<input class="form-control" style="display: none;" name="id" value="<?php echo $stroka["id"]?>">
	 								<input type="" name="img" class="" placeholder="Картинка" value="<?php echo $stroka["img"]?>">
	 								<input type="" name="text" class="mt-1" placeholder="Текст" value="<?php echo $stroka["text"]?>">
	 								<button class="btn btn-danger mt-1 knopka2">Сохранить</button>
	 							</form>				
	 					</div>					
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		let knopka2 = document.querySelectorAll(".knopka2")
		for (let i = 0;i < 3; i++) {
			knopka[i].onclick = function(){
			forma[i].style.display = "block";
			knopka[i].style.display = "none";
			}
		}
